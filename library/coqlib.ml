...
let id = Constant.make_canonical datatypes_module @@ Label.make "idProp"
let type_of_id = Constant.make_canonical datatypes_module @@ Label.make "IDProp"

(** Natural numbers *)
let nat_kn = MutInd.make_canonical datatypes_module @@ Label.make "nat"
...
(** Booleans *)
let bool_kn = MutInd.make_canonical datatypes_module @@ Label.make "bool"
...
(** Equality *)
let eq_kn = MutInd.make_canonical logic_module @@ Label.make "eq"
let glob_eq = GlobRef.IndRef (eq_kn,0)

let identity_kn = MutInd.make_canonical datatypes_module @@ Label.make "identity"
let glob_identity = GlobRef.IndRef (identity_kn,0)

let jmeq_kn = MutInd.make_canonical jmeq_module @@ Label.make "JMeq"
