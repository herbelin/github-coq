...
let interp o ?loc n =
  ...
  | Warning threshold, n when NumTok.Signed.is_int_less_than n threshold ->
  ...
  | Abstract threshold, Direct when NumTok.Signed.is_int_less_than n threshold ->
...
let notation_of_prim_token = function
  | Numeral n -> InConstrEntrySomeLevel, NumTok.Signed.to_string n
