...
val intern_constr : env -> Id.Set.t -> constr_expr -> glob_constr

val intern_type : env -> Id.Set.t -> constr_expr -> glob_constr

val intern_gen : typing_constraint -> env ->
  ?impls:internalization_env -> ?pattern_mode:bool -> ?ltacvars:ltac_sign ->
  Id.Set.t -> constr_expr -> glob_constr

val intern_pattern : env -> cases_pattern_expr ->
  Id.t list * (Id.t Id.Map.t * cases_pattern) list

val intern_context : bool -> env -> Id.Set.t -> internalization_env -> local_binder_expr list -> internalization_env * glob_decl list
...
val interp_constr : env -> evar_map -> Id.Set.t -> ?impls:internalization_env ->
  constr_expr -> constr Evd.in_evar_universe_context

val interp_casted_constr : env -> evar_map -> Id.Set.t -> ?impls:internalization_env ->
  constr_expr -> EConstr.types -> constr Evd.in_evar_universe_context

val interp_type : env -> evar_map -> Id.Set.t -> ?impls:internalization_env ->
...
val interp_open_constr : env -> evar_map -> Id.Set.t -> constr_expr -> evar_map * EConstr.constr

(** Accepting unresolved evars *)

val interp_constr_evars : env -> evar_map ref -> Id.Set.t ->
  ?impls:internalization_env -> constr_expr -> EConstr.constr

val interp_casted_constr_evars : env -> evar_map ref -> Id.Set.t ->
  ?impls:internalization_env -> constr_expr -> types -> EConstr.constr

val interp_type_evars : env -> evar_map ref -> Id.Set.t ->
...
val interp_constr_evars_impls : env -> evar_map ref -> Id.Set.t ->
  ?impls:internalization_env -> constr_expr ->
  EConstr.constr * Impargs.manual_implicits

val interp_casted_constr_evars_impls : env -> evar_map ref -> Id.Set.t ->
  ?impls:internalization_env -> constr_expr -> EConstr.types ->
  EConstr.constr * Impargs.manual_implicits

val interp_type_evars_impls : env -> evar_map ref -> Id.Set.t ->
  ?impls:internalization_env -> constr_expr ->
...
val intern_constr_pattern :
  env -> ?as_type:bool -> ?ltacvars:ltac_sign -> Id.Set.t ->
...
val interp_binder  : env -> evar_map -> Id.Set.t -> Name.t -> constr_expr -> 
  types Evd.in_evar_universe_context

val interp_binder_evars : env -> evar_map ref -> Id.Set.t -> Name.t -> constr_expr -> EConstr.types

(** Interpret contexts: returns extended env and context *)

val interp_context_evars :
  ?global_level:bool -> ?impl_env:internalization_env -> ?shift:int ->
  env -> evar_map ref -> Id.Set.t -> local_binder_expr list ->
