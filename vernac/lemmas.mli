...
val start_proof : Environ.env -> Id.t -> ?pl:UState.universe_decl -> goal_kind -> Evd.evar_map ->
  ?terminator:(Proof_global.lemma_possible_guards -> declaration_hook -> Proof_global.proof_terminator) ->
  ?sign:Environ.named_context_val -> EConstr.types ->
  ?init_tac:unit Proofview.tactic -> ?compute_guard:Proof_global.lemma_possible_guards ->
  declaration_hook -> unit

val start_proof_univs : Environ.env -> Id.t -> ?pl:UState.universe_decl -> goal_kind -> Evd.evar_map ->
...
val start_proof_com :
  Environ.env -> ?inference_hook:Pretyping.inference_hook ->
  goal_kind -> Vernacexpr.proof_expr list ->
  declaration_hook -> unit

val start_proof_with_initialization :
  Environ.env -> goal_kind -> Evd.evar_map -> UState.universe_decl ->
...
val universe_proof_terminator :
  Environ.env -> Proof_global.lemma_possible_guards ->
...
val save_proof : Environ.env -> ?proof:Proof_global.closed_proof -> Vernacexpr.proof_end -> unit
