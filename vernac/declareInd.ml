...
let declare_mutual_inductive_with_eliminations ?(primitive_expected=false) ?typing_flags mie univs impls =
  ...
  DeclareUniv.declare_univ_binders (GlobRef.IndRef (mind,0)) univs;
