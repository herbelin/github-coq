...
let () = create_generic_quotation "uconstr" Pcoq.Constr.constr Constrarg.wit_uconstr
let () = create_generic_quotation "constr" Pcoq.Constr.constr Constrarg.wit_constr
let () = create_generic_quotation "ipattern" Pcoq.Tactic.simple_intropattern Constrarg.wit_intro_pattern
let () = create_generic_quotation "open_constr" Pcoq.Constr.constr Constrarg.wit_open_constr
let () =
  let inject (loc, v) = Tacexpr.Tacexp v in
  Tacentries.create_ltac_quotation "ltac" inject (Pcoq.Tactic.tactic_expr, Some 0)
